...
var prCmd = &cobra.Command{
	...
	Long: `Checkout a pull request by number. This is a convenience alias for 'wtm add pr/<number>'.

Examples:
  wtm pr 123           # Checkout PR #123 to pr-123/
  wtm pr 123 my-dir    # Checkout PR #123 to my-dir/`,
